...
namespace Company.WebAPI.Clients.Identity
{
    ...
    {
        public RolesClient(HttpClient Client) : base(Client, "api/v1/roles")
        {
        }
        ...
        {
            var response = await PostAsync(Address, role, cancellationToken);
